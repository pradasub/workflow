...
def describe():
    ...
    return print(
        ...
        f'model, coeff_df = logistic_regression(X_train, y_train,\n'
        f'col_order,random_state=99,solver="lbfgs",n_jobs=4)\n'
        f'logistic_metrics(model,X_test, y_test) get intercept and r2 for the model'
    )

def logistic_regression(
    X_train, y_train, col_order,random_state=99,solver="lbfgs",n_jobs=4
):
