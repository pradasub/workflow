def describe():
    return print(
        ...
        f'maj_null, bias_n_unique = flag_vars(\n'
        f'df,bias_ratio = 0.9,frac=1,perc_null_gtr = 50.,n_unique_for_bias_check=10)\n'
...
def flag_vars(
    df,bias_ratio = 0.9,frac=1,perc_null_gtr = 50.,n_unique_for_bias_check=10
):
