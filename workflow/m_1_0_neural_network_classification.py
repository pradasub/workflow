...
def describe():
    return print(
        ...
        f'basic_model_classification(in_shape,out_shape, total_hidden_layer,opt_func="Adam",learning_rate=0.001,loss_func="sparse_categorical_crossentropy",metric="accuracy")\n'
