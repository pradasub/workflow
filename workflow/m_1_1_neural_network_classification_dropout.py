...
def describe():
    ...
    return print(
        ...
        f'basic_model_classification(in_shape,out_shape,\n'
        f'total_hidden_layer,opt_func="Adam",learning_rate=0.001,loss_func="sparse_categorical_crossentropy",\n'
        f'metric="accuracy",dropout=0.2)\n'
...
def basic_model_classification(
    ...
    learning_rate=0.001,loss_func='sparse_categorical_crossentropy',
    metric='accuracy',dropout=0.2
):
