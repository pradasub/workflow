...
def describe():
    return print(
        f'Neural Network Model for Regression\n'
        ...
        f'basic_model_classification(in_shape,total_hidden_layer,opt_func="Adam",learning_rate=0.001,loss_func="mse",metric=["mse","mae"])\n'
