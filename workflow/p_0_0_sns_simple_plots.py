...
def describe():
    return print(
        ...
        f'pair_plot(data, sample) -> pass in data.sample(n = your_choice) default is 0.5,draction of dataframe to be passed\n'
        ...
        f'bar_plot(data,x,y,hue=None) -> bar plot with x and y column and hue. Gives mean of the bar plot. Estimator=median not working\n'
